...
const ERROR_MESSAGES = {
    ...
    MODAL_ID_INVALID_FROM_USEMODAL: (id) => `react-simple-modal-provider: useModal Error! ID "${id}" is not valid`,
    MODAL_ID_NOT_EXIST: (id) => `react-simple-modal-provider: useModal Error! ID "${id}" not exist. Check the order of value props passed to "ModalProvider".`,
